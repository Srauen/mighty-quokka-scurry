...
import { Bell, List, LayoutGrid, TrendingUp, TrendingDown, Star, LayoutDashboard, Brain, Settings, ChevronLeft, ChevronRight, Cloud } from 'lucide-react'; // Removed LineChart icon
...
const DashboardSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    // { id: 'multi-charts', icon: LineChart, label: 'Multi Charts', link: '/dashboard/multi-charts' }, // Removed item
